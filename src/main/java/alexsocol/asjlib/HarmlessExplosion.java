...
public class HarmlessExplosion {
	...
	public void doExplosionA() {
		...
		int i2 = MathHelper.floor_double(this.explosionY + (double)this.explosionSize + 1.0);
		...
		for (int i1 = 0; i1 < list.size(); ++i1) {
			...
			if (d4 <= 1.0) {
				...
				if (d9 != 0.0) {
					...
					entity.attackEntityFrom(DamageSource.setExplosionSource((Explosion)null), (float)((int)((d11 * d11 + d11) / 2.0 * 8.0 * (double)this.explosionSize + 1.0)));
