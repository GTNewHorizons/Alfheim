package alfmod.common.core.helper
...
object IconHelper {
    ...
    fun forName(ir: IIconRegister, name: String): IIcon = ir.registerIcon("${AlfheimModularCore.MODID}:$name")

    fun forName(ir: IIconRegister, name: String, dir: String): IIcon = ir.registerIcon("${AlfheimModularCore.MODID}:$dir/$name")
