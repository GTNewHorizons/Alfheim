...
class AIRays(flugel: EntityFlugel, task: AITask) : AIBase(flugel, task) {
	...
	fun getBurst(flugel: EntityFlugel, i: Int): EntityManaBurst {
		...
		burst.setColor(Color(179, 77, 179).getRGB())
		burst.setMana(1)
		...
		burst.setLocationAndAngles(flugel.posX, flugel.posY + flugel.getEyeHeight(), flugel.posZ, i.toFloat(), -flugel.rotationPitch)
