...
public class WAILAAlfheimConfig {
	...
	public static void loadConfig() {
		...
		ModuleRegistrar.instance().registerBodyProvider(new WAILAHandlerItemHolder(), TileItemHolder.class);
		ModuleRegistrar.instance().registerNBTProvider(new WAILAHandlerItemHolder(), TileItemHolder.class);
