...
public class ItemManaStorage extends Item implements IManaItem, IManaTooltipDisplay, IBauble {
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean b) {
		list.add(StatCollector.translateToLocalFormatted("item.manastorage.desc0", (((double) this.MAX_MANA) / ((double) TilePool.MAX_MANA))));
		list.add(StatCollector.translateToLocalFormatted("item.manastorage.desc1", getMana(stack), getMaxMana(stack)));
	}
}
