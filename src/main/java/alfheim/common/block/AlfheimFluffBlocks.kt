...
object AlfheimFluffBlocks {
	...
	init {
		shrineRock = BlockModMeta(Material.rock, 16, ModInfo.MODID, "ShrineRock", hard = 10f, harvLvl = 2, resist = 10000f, folder = "shrines/")
		...
		shrineLight = BlockModMeta(Material.glass, 4, ModInfo.MODID, "ShrineLight", resist = 6000f, folder = "shrines/").setLightLevel(1f).setLightOpacity(0)
		...
		livingcobbleStairs = BlockModStairs(AlfheimBlocks.livingcobble, 0).setBlockName("LivingCobbleStairs")
