...
public class ElvenOres extends Block {
	...
	public static final String[] names = { "Dragonstone", "Elementium", "Quartz", "Gold" };
	public IIcon[] textures = new IIcon[names.length];
	public Item[] drops = { ModItems.manaResource, Item.getItemFromBlock(AlfheimBlocks.elvenOres), ModItems.quartz, Item.getItemFromBlock(AlfheimBlocks.elvenOres) };
