...
public class DamageSourceSpell extends DamageSource {
	...
	public static DamageSource missile(EntitySpellIsaacMissile im, EntityLivingBase caster) {
		return new EntityDamageSourceIndirectSpell("missile", caster, im).setMagicDamage();
	}
