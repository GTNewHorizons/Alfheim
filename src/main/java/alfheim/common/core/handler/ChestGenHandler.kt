...
object ChestGenHandler {
	...
	init {
		...
		ChestGenHooks.addItem(c, WeightedRandomChestContent(ItemStack(AlfheimItems.storyToken), 1, 2, 6))
		
		c = ChestGenHooks.PYRAMID_DESERT_CHEST
		ChestGenHooks.addItem(c, WeightedRandomChestContent(ItemStack(AlfheimItems.storyToken), 1, 2, 4))
