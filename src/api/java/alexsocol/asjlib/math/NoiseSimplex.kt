...
/*
 * A speed-improved simplex noise algorithm for 2D, 3D and 4D in Java (kotlin port).
 *
...
object NoiseSimplex {
	...
	fun main(args: Array<String>) {
		println(perm.contentToString())
		println(permMod12.contentToString())
	}
	
	// Simplex noise in 2D, 3D and 4D
	private val grad3 = arrayOf(Grad(1, 1, 0), Grad(-1, 1, 0), Grad(1, -1, 0), Grad(-1, -1, 0),
	                            Grad(1, 0, 1), Grad(-1, 0, 1), Grad(1, 0, -1), Grad(-1, 0, -1),
	                            Grad(0, 1, 1), Grad(0, -1, 1), Grad(0, 1, -1), Grad(0, -1, -1))
	
	private val grad4 = arrayOf(Grad( 0,  1, 1, 1), Grad( 0,  1,  1, -1), Grad( 0,  1, -1, 1), Grad( 0,  1, -1, -1),
	...
	fun noise(x: Double, y: Double): Double {
		...
		val ii = i and 255
		val jj = j and 255
		val gi0 = permMod12[ii + perm[jj]].I
		val gi1 = permMod12[ii + i1 + perm[jj + j1]].I
		val gi2 = permMod12[ii + 1 + perm[jj + 1]].I
	...
	fun noise(x: Double, y: Double, z: Double): Double {
		...
		val jj = j and 255
		val kk = k and 255
		val gi0 = permMod12[ii + perm[jj + perm[kk]]].I
		val gi1 = permMod12[ii + i1 + perm[jj + j1 + perm[kk + k1]]].I
		val gi2 = permMod12[ii + i2 + perm[jj + j2 + perm[kk + k2]]].I
		val gi3 = permMod12[ii + 1 + perm[jj + 1 + perm[kk + 1]]].I
	...
	private data class Grad(var x: Double, var y: Double, var z: Double, var w: Double = 0.0)
	private fun Grad(x: Int, y: Int, z: Int, w: Int = 0) = Grad(x.D, y.D, z.D, w.D)
}